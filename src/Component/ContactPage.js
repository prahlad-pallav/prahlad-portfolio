...
const ContactPage = () => {
  return (
    <div className='mt-10 px-5'>
        ...
        <Form />
        <div className='text-[1.25rem] font-semibold text-[#0077B6] mb-4 text-left lg:text-left lg:text-[1.75rem] mt-10 underline'>Social Media?</div>
        <div className='flex flex-row gap-4 items-center py-2 text-center'>
            ...
            <a href="mailto:prahladpallav147@gmail.com" className='text-[#023E8A] font-semibold text-[0.875rem] sm:text-xl underline'>prahladpallav147@gmail.com</a>
        </div>
        <div className='flex flex-row gap-4 items-center py-2'>
            <div className='w-[30px] sm:w-[40px]'>
                <img src={likedin_logo} alt="" srcset="" className='object-contain'/>
            </div>
            <a href="https://www.linkedin.com/in/prahladpallav/" className='text-[#023E8A] font-semibold text-[0.875rem] sm:text-xl underline'>linkedin.com/in/prahladpallav/</a>
        </div>
        <div className='flex flex-row gap-4 items-center py-2'>
            <div className='w-[30px] sm:w-[40px]'>
